...
* The template must be written in **AsciiDoc (https://docs.asciidoctor.org/asciidoc/latest/syntax-quick-reference/[Asciidoctor flavor])** - with sections starting with `#` characters, not `=`.
